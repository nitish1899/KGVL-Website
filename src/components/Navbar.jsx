...
//               style={{
//                 textShadow:
//                   "2px 2px 4px yellow, 4px 4px 6px rgba(0, 0, 0, 0.6)",
//               }}
//             >
...
//               Pearls Omaxe, Netaji Subash Place, Pitampura, New Delhi
//             </span>
//           </div>
//           <div className="flex flex-col items-center">
...
//               className="hover:border-b-2 hover:border-[#ecf662] flex items-center"
//             >
...
//             className="text-blue-600 text-2xl hover:text-blue-600"
//             target="_blank"
//             rel="noopener noreferrer"
//           >
//             <FaTwitter />
...
//           } flex flex-col sm:flex-row items-center justify-center animate-bg-color-change p-4`}
//         >
//           <div className="text-lg text-white text-center sm:text-left mb-4 sm:mb-0 sm:mr-4">
//             [Contest is Live]!! Participate & get a chance to convert your
//             petrol bike to a hybrid completely. Click below to know more.
//           </div>
//           <div>
//             <Link
    ...
    <div className="sticky top-0 z-50 w-screen bg-yellow-100">
      <div className="flex flex-row md:flex-row items-center justify-between align-middle max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="hidden md:flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 active:scale-95 transition-all duration-200 text-white text-lg font-bold px-4 py-2 rounded-xl"
        >
          <span>Book Now</span>
