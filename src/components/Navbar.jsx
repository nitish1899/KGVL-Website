...
export const Navbar = () => {
	...
	return (
		<div className="sticky top-0 z-50 py-2 w-screen bg-white shadow-lg">
			<div className="flex flex-row md:flex-row items-center justify-between align-middle max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
				...
				<button
					...
					className="hidden md:flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 active:scale-95 transition-all duration-200 text-white text-base sm:text-base md:text-sm lg:text-xl font-semibold px-3 py-1.5 sm:px-3 sm:py-1.5 md:px-2.5 md:py-1.5 md:mx-4 lg:px-3 lg:py-2 rounded-xl"
				>
