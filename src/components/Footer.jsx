...
import kgvmitr from '../resource/kgvmitr1.png';
...
export const Footer = () => {
	return (
		<footer className="relative text-gray-800 px-6 py-10 text-2xl overflow-hidden w-full">
			<div
			...
			<div className="relative z-10 xl:w-3/4 mx-auto grid gap-8 md:grid-cols-5">
				...
				{/* Column 2: Home */}
				<div className="text-center md:text-left text-green-800">
				...
				<div className="text-center md:text-left text-xl color:'#00433D' text-black">
					...
					<div className="flex">
						<p className=""></p>
						<p>📞</p> <p className="font-bold mr-2 text-nowrap">Phone: </p>
						<p>+919661829944</p>
					</div>
			...
			<p className="mt-8 text-center text-xl font-semibold text-green-800 relative z-10">
